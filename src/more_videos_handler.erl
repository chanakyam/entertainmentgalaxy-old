...
welcome(Req, State) ->
	...
	Url_all_news = string:concat("http://api.contentapi.ws/videos?channel=movies&limit=10&skip=",integer_to_list(SkipItems)),
	...
	{ok, Body} = more_videos_dtl:render([{<<"videoParam">>,Params},{<<"news_category">>,Category},{<<"allnews">>,ParamsAllNews}]),
    {Body, Req, State}.
